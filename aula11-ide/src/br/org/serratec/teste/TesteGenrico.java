...
public class TesteGenrico {
	...
	public static void main(String[] args) {
		...
		//Qualquer coisa que tenha como o super a classe Funcionario
		MeuGenerico<? super Funcionario> mg4 = new MeuGenerico<Funcionario>(new Diretor("Marcos", "m@gmail.com",
																				9000., "CIO"));
